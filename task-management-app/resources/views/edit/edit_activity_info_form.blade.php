<div class="container pb-3">
    ...
    <div class="section-1">
        ...
        <form action="{{ route('activity.edit') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="titleInput">Title</label>
                <input type="text" class="form-control" name="titleInput" id="titleInput" aria-describedby="titleInput"
                    placeholder="Enter the Title" wire:model="added_title">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nameInput" name="nameInput" aria-describedby="nameInput"
                    placeholder="John Doe" wire:model="added_name">
                ...
                <div class="row">
                    <div class="col">
                        <input type="text" id="startDate" name="startDate" class="date form-control"
                            placeholder="Start Date" wire:model="added_start_date">
                        @error('startDate')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col">
                        <input type="text" id="endDate" name="endDate" class="date form-control"
                            placeholder="End date" wire:model="added_end_date">  
                        @error('endDate')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
